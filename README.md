...
- [Linux (amd64)](https://github.com/thingsdb/ThingsCode/releases/download/v1.0.3/ticode-linux-amd64-1.0.3.tar.gz)
- [Linux (arm64)](https://github.com/thingsdb/ThingsCode/releases/download/v1.0.3/ticode-linux-arm64-1.0.3.tar.gz)
- [Darwin (amd64)](https://github.com/thingsdb/ThingsCode/releases/download/v1.0.3/ticode-darwin-amd64-1.0.3.tar.gz)
- [Darwin (arm64)](https://github.com/thingsdb/ThingsCode/releases/download/v1.0.3/ticode-darwin-arm64-1.0.3.tar.gz)
- [Windows (amd64)](https://github.com/thingsdb/ThingsCode/releases/download/v1.0.3/ticode-windows-amd64-1.0.3.tar.gz)
- [Windows (arm64)](https://github.com/thingsdb/ThingsCode/releases/download/v1.0.3/ticode-windows-arm64-1.0.3.tar.gz)

**2. Extract the contents of the archive using a tool like `tar`. Here's an example for Linux (amd64):**

```bash
tar -xzvf ticode-linux-amd64-1.0.3.tar.gz
```
